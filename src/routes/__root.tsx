...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Painel executivo de acompanhamento de IMC e Peso — programa HEALTHBIT / RDsaúde." },
      { name: "twitter:description", content: "Painel executivo de acompanhamento de IMC e Peso — programa HEALTHBIT / RDsaúde." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/01737725-5fab-4835-bdb3-efab88aebfc9/id-preview-7c5a7c0b--90d37ab6-9799-4b34-b22f-d759c0734cf7.lovable.app-1778516970997.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/01737725-5fab-4835-bdb3-efab88aebfc9/id-preview-7c5a7c0b--90d37ab6-9799-4b34-b22f-d759c0734cf7.lovable.app-1778516970997.png" },
